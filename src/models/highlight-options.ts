...
export default interface IHighlightOptions {
  ...
  /**
   * Overrides the update delay for the highlight elements.
   *
   * By default, the position and size of highlight's elements will be updated every
   * `0` miliseconds.
   */
  highlightUpdateDelay?: number;

  /**
   * Overrides the update delay for popup element.
   *
   * By default, the popup element will be updated every `0` miliseconds.
   */
  popupUpdateDelay?: number;
}
